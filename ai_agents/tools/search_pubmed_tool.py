...
class SearchPubmedTool(BaseTool):
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        try:
            ...
            collection_result = self._save_to_collection(output_folder, collection_name, user_id)
    ...
    def _save_to_collection(self, output_folder: str, collection_name: str, user_id: int) -> Dict[str, Any]:
